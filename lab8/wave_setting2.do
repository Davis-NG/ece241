...
add wave -noupdate /part1/R0/ClockIn
add wave -noupdate /part1/R0/Resetn
add wave -noupdate /part1/R0/enable
add wave -noupdate /part1/R0/FrameCounter
add wave -noupdate /part1/R0/newFrame
add wave -noupdate /part1/R0/Divider
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2355400 ps} 0}
...
update
WaveRestoreZoom {2272540 ps} {2584450 ps}
